...
import DetailsSkeleton from "../../skeleton/ProdectDetialSkeleton";
...
const Details = () => {
  ...
  const { CartSaveRequest, CartForm, CartListRequest, CartFormChange } =
    CartStore();
  const { WishListRequest, WishSaveRequest } = WishShore();
    ...
    return (
      <div>
        <div className="container mt-2">
          <div className="row">
            {/* ProductImage.jsx.................................... */}
            <div className="col-md-7 p-3"><ProductImages /></div>
              ...
              <div className="row">
                ...
                <div className="col-4 p-2">
                  ...
                  <div className="input-group my-2">
                    ...
                    <input value={quantity} type="text" className="form-control bg-light text-center" readOnly/><button onClick={incrementQuantity} className="btn btn-outline-secondary">+</button>
                  </div>
                </div>
          ...
          <div className="row mt-3">
            ...
            {/* Specifications ///  Review /// pages details.............................. */}
            <div className="tab-content" id="myTabContent">
              <div className="tab-pane fade show active" id="Speci-tab-pane" role="tabpanel" aria-labelledby="Speci-tab">
                {/* des => import parse from "html-react-parser"; */}
