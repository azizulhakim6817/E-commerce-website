...
const Products = () => {
  ...
  return (
    <div className="section ">
      <div className="container-fluid py-5 bg-white mt-2">
        <div className="row bg-body-tertiary ">
          <h1 className="headline-4 text-center my-2 p-0 mt-4">Our Products</h1>
              ...
              >
                ...
                <li className="nav-item" role="presentation">
                  <button
                    ...
                    className="nav-link 98px fw-bold "
                    ...
                    <div className="container">
                      <div className="row">
                        {ListByRemark.map((item, i) => {
                          ...
                          return (
                            <div className="col-md-2 p-2 col-lg-3 col-sm-6 col-12">
                              <Link
                                to={`/details/${item["_id"]}`}
                              ...
                              >
                                ...
                                <div className="card-body">
                                  <p className=" fs-5 text-black fw-bold my-1">
                                  ...
                                  <div className="my-2 d-flex">
                                    ...
                                    <button className="btn custom-blue ms-4">
                                      Learn more
                                    </button>
                                  </div>
                                  <p className=" fsSize- text-secondary  my-1">
                                    {item["shortDes"].slice(0, 60)}
                                  </p>
                                </div>
                              </Link>
                            </div>
