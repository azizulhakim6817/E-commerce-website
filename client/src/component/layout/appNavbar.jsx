...
const AppNavbar = () => {
  ...
  const { WishCount, WishListRequest } = WishShore();
            ...
            <div className="col-md-6">
              <span>
                ...
                <span className="f-12 mx-2">
                  <i className="bi bi-envelope"></i>
                  <a href="tel:01743086886" className="ms-2 text-white">
                    01743-086886
                  </a>
                </span>
              </span>
          ...
          <div className="collapse navbar-collapse" id="nav06">
            <ul className="navbar-nav mt-3 mt-lg-0 mb-3 mb-lg-0 ms-lg-3">
              <span className="nav-item me-4">
                <Link className="btn ms-1 btn-light position-relative" to="/">
            ...
            {isLogin() ? (
              <>
                ...
                <Link
                  to="/orders"
                  type="button"
                  className="btn ms-4 btn-light position-relative d-flex align-items-center gap-2"
                >
